...
<section class="text-gray-600 body-font relative" id="registration">
    ...
    <div class="container px-5 pt-10 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-red-900">GATANAYAKS / GATASWAYASEVAKS INFORMATION</h1>
            <h4 class="text-red-900">(గటనాయకులు / గటస్వయంసేవకుల ఇన్ఫర్మేషన్)</h4>
        </div>
...
చిరునామా సమాచారం)</span>
                        ...
                        <div class="p-5 col-span-full w-full">
                            <input type="submit" class="flex mx-auto text-white bg-red-900 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" value="SUBMIT">
                        </div>
                    </div>
                </form>
            </div>
